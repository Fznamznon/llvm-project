...
public:
  ...
  virtual llvm::sys::ProcessInfo
  Execute(ArrayRef<Optional<StringRef>> Redirects, std::string *ErrMsg,
...
public:
  ...
  llvm::sys::ProcessInfo Execute(ArrayRef<Optional<StringRef>> Redirects, std::string *ErrMsg,
